...
def plot_pca_maps(pca, maps, pts, clrs, recon, unique_clrs, matched_pixels, matched_signals,  Working_Directory,\
    name_for_saving_figures, filename_save_prefix, stim_start, stim_end):
