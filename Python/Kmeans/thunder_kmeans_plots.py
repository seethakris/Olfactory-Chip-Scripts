...
Plot kmeans components and maps for OB data 
@author: seetha
"""
...
def plot_kmeans_maps(Working_Directory, name_for_saving_figures, name_for_saving_files, \
    ...
    pp = PdfPages(Figure_PDFDirectory+name_for_saving_files+'_kmeans.pdf')
...
#    ##  Plot color maps individually #######################
    if flag == 0:
        plot_colormaps_ind(brainmap, Working_Directory, name_for_saving_figures, pp)
    elif flag == 1:
        plot_colormaps_each(brainmap, Working_Directory, name_for_saving_figures, pp,matched_pixels, unique_clrs)
    elif flag == 2:
        plot_colormaps_all(brainmap, Working_Directory, pp, matched_pixels, unique_clrs)
        plot_colormaps_all_z_plane_wise(brainmap, Working_Directory, pp,matched_pixels, unique_clrs)
